...
if modulos == "Home":
    ...
    st.markdown(
        "<h1 align='center'>APLICACIÓN EN STREAMLIT</h1>",
    ...
    st.markdown(
        ...
        "en clase, consolidando los contenidos del primer módulo "
        "de Python Fundamentals."
    )
...
# =========================================================
    ...
    st.markdown(
        """
        En este ejercicio se registrarán movimientos financieros
        utilizando una lista. Cada movimiento tendrá un concepto,
        un tipo de movimiento y un valor. El sistema calculará el
        total de ingresos, el total de gastos y el saldo final.
        """
    )
    ...
    if st.button("Agregar movimiento"):
        ...
        if concepto == "":
            st.error(
                "Ingrese un concepto para registrar el movimiento."
            )
...
# =========================================================
    ...
    st.markdown(
        """
        En este ejercicio se registrarán productos utilizando
        arreglos de NumPy. Cada registro contiene el nombre del
        producto, categoría, precio, cantidad y total.
        """
    )
    ...
    st.markdown(
        f"**Total del registro: S/ {total:.2f}**"
    )
...
# =========================================================
    ...
    st.title(
        "Ejercicio 3 - Cálculo de préstamo"
    )

    st.markdown(
        """
        En este ejercicio se utilizará una función de una
        librería externa para calcular la cuota mensual de
        un préstamo bajo el sistema francés.
        """
    )
    ...
    if st.button("Calcular préstamo"):
        ...
        st.write(
            f"Cuota mensual: "
            f"S/ {resultado['cuota_mensual']:.2f}"
        )

        st.write(
            f"Total pagado: "
            f"S/ {resultado['total_pagado']:.2f}"
        )

        st.write(
            f"Interés total: "
            f"S/ {resultado['interes_total']:.2f}"
        )
...
# =========================================================
    ...
    st.title(
        "Ejercicio 4 - Inventario con CRUD"
    )
        ...
        if st.button(
            ...
            for producto in st.session_state.inventario:
                ...
                if producto.nombre == producto_eliminar:
                    ...
                    st.session_state.inventario.remove(
                        producto
                    )
